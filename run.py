...
pages = {
    ...
    'westminster_whitebadge': Question(id='westminster_whitebadge', text='With a disabled White Badge?', image='white_badge.png',
                                       result_yes='resident_payanddisplay_kensington', result_no='westminster_resident'),
    'westminster_resident': Question(id='westminster_resident', text='In a resident bay?',
    ...
    '4hours': Statement(id='4hours', text='For up to 4 hours in controlled time, otherwise unlimited.'),
